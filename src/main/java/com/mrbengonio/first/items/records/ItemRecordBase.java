...
public class ItemRecordBase extends Item {
	public static final Map<SoundEvent, ItemRecordBase> RECORDS = Maps.<SoundEvent, ItemRecordBase>newHashMap();
	public final SoundEvent sound;
	public final String displayName;

	public ItemRecordBase(String p_i46742_1_, SoundEvent soundIn) {
	...
	@Nullable
	@SideOnly(Side.CLIENT)
	public static ItemRecordBase getBySound(SoundEvent soundIn) {
		return (ItemRecordBase) RECORDS.get(soundIn);
	}
